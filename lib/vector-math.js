 ...
 * The weight vector is applied elementwise before computing cosine similarity.
 * @param {number[]} a
 * @param {number[]} b
 * @param {number[]} w
 * @returns {number}
 */
export function weightedCosineSimilarity(a, b, w) {
  if (!Array.isArray(w)) return cosineSimilarity(a, b);
